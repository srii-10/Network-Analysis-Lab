...
2. Create a login form
  ...
  - Fill in the login.html file:
    <img src="images/login.png" alt="Scan Result" width="500"/>

3. Run Python HTTP Server
  <img src="images/http.server.png" alt="Scan Result" width="500"/> <br>
...
5. Access login form from browser
  - Since the web server is up, run this in the browser: http://localhost:8080/login.html <br>
...
6. Entering username and password
  - After the login form appears, enter the original username and password. Here I enter: <br>
    username: admin <br>
    password: 123456 <br>
    <img src="images/login-form.png" alt="Scan Result" width="500"/>
  - An 'Error response' will appear. Because the login form is created without validation.
    <img src="images/error-login.png" alt="Scan Result" width="500"/>
...
7. Capture network packets
  ...
  - Use filters to facilitate customized searches. Here I filtered: http.request.method == “POST” <br>
    <img src="images/capture.png" alt="Scan Result" width="500"/> <br>
...
1. Results that can be seen immediately when clicking on the network packet and will appear below the network packet screen.
   <img src="images/1.png" alt="Scan Result" width="500"/> <br>
   The analysis: <br>
   ...
   <img src="images/2.png" alt="Scan Result" width="500"/> <br>
...
2. Results that can be seen by right-clicking on the network packet, then selecting Follow > HTTP Stream
   <img src="images/full.png" alt="Scan Result" width="500"/> <br>
